            ...
            if(subSentence.isFound){
                if(!subSentence.isContained){ // Don't take into account of this subsentence if this subsentence is a subsentence of some other subsentence which matches with the compared sentence.
                    ...
                    for(Integer wordIndex: subSentence.subSentenceWordIndexList){
                        comparisonResultOfSentences.foundWordsIndexList.add(wordIndex); // Since the hashset does not keep the same value more than once, if some part of the plagiarised part repeats in more than one subsentence, it will keep the plagiarised part's index only once.
                    }
                }
            }
        }
        ...
        for(SourceDocSentence sourceDocSentence: sourceDocSentenceList){
            for(ComparisonResultOfSentences comparisonResultOfSentences: sourceDocSentence.listOfComparisonResultOfSentences){
                for(Integer wordIndex: comparisonResultOfSentences.foundWordsIndexList){
                    foundWordsIndexList.add(wordIndex); // Since the hashset does not keep the same value more than once, if plagiarised part or some part of the plagiarised part repeats in more than one targetdocsentence, it will keep the plagiarised part's index only once.
                }
            }
